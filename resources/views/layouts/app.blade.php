    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="/">
                <img src="{{ asset('img/logo-albarokah.jpg') }}" alt="Logo" style="height: 45px;" class="me-2">
                SMK AL BAROKAH
            </a>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ url('/profil') }}">Visi & Misi</a></li>
            ...
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ asset('img/logo-albarokah.jpg') }}" alt="Logo" style="width: 50px;" class="me-2">
                ...
                <div class="col-md-2 mb-4 ms-auto">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2"><a href="{{ url('/') }}" class="text-decoration-none text-danger fw-bold">Beranda</a></li>
                        <li class="mb-2"><a href="{{ url('/profil') }}" class="text-decoration-none text-dark">Profile</a></li>
